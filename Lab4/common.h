 ...
 * common.h
 *
 * Containing a set of different macros for performing bit-manipulation on the registers 
 * of AVR ATMEGA processor. Operations are useful for reading and manipulating I/O amongst other things.
 * 
